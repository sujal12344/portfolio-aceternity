...
import GridGlobe from "./GridGrobe";
...
export const BentoGridItem = ({
  ...
  const leftLists = ["prisma", "postgreSQL", "Nextjs", "Typescript"];
  const rightLists = ["React", "TailwindCSS", "Nodejs", "ShadCN"];
  ...
  const handleCopy = () => {
    const text = "sujalkesharwani220@gmailcom";
